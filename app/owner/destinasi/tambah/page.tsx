...
export default function OwnerTambahDestinasiPage() {
  ...
  useEffect(() => {
    fetch('/api/destinations/categories').then(r => r.json()).then(setCategories)
  }, [])
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/owner/destinations', {
      method: 'POST',
